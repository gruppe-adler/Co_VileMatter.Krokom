...
private _soundSources = [];
{
	...
	sleep ((random 5) + 0.5);
} forEach [GRAD_VM_phase2_ambient_1, GRAD_VM_phase2_ambient_2, GRAD_VM_phase2_ambient_3, GRAD_VM_phase2_ambient_4, GRAD_VM_phase2_ambient_5, GRAD_VM_phase2_ambient_6];
