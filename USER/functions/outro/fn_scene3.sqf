...
_copilot say3d ["feiglinge_default", 500, 1, true]; // say3d didnt work on dedicated due to unknown reasons
sleep 1;
_copilot say3d ["verraeterversager_default", 500, 1, true]; // say3d didnt work on dedicated due to unknown reasons
sleep 2;
