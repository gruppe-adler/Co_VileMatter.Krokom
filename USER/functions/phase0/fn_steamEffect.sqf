...
_particleSource setParticleParams [["\A3\data_f\cl_basic.p3d", 1, 0, 1], "", "Billboard", 1, 1.5, [0, 0, -1],
 [0, 0, 3], 0, 10, 7.9, 0.075, [0.2, 2], [[0.7, 0.7, 0.7, 0.01], [0.25, 0.25, 0.25, 0.5], [0.5, 0.5, 0.5, 0]], [0.08], 1, 0, "", "", "",0];
