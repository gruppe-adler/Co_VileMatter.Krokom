class AF_KeyPad
{
	...
	onUnload = "if (!isNull GRAD_VM_keypadDoor) then { GRAD_VM_keypadDoor setVariable ['GRAD_VM_keyPadInUse', false, true]; };";
	class controls 
	{
...
class AF_Key1: RscButton
{
	...
	Action = "[""number"", 1]execVM ""USER\functions\phase0\keypad\AF_KP_fncs.sqf""";
};
class AF_Key2: RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""number"", 2]execVM ""USER\functions\phase0\keypad\AF_KP_fncs.sqf""";
};
class AF_Key3: RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""number"", 3]execVM ""USER\functions\phase0\keypad\AF_KP_fncs.sqf""";
};
class AF_Key4: RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""number"", 4]execVM ""USER\functions\phase0\keypad\AF_KP_fncs.sqf""";
};
class AF_Key5: RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""number"", 5]execVM ""USER\functions\phase0\keypad\AF_KP_fncs.sqf""";
};
class AF_Key6: RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""number"", 6]execVM ""USER\functions\phase0\keypad\AF_KP_fncs.sqf""";
};
class AF_Key7: RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""number"", 7]execVM ""USER\functions\phase0\keypad\AF_KP_fncs.sqf""";
};
class AF_Key8: RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""number"", 8]execVM ""USER\functions\phase0\keypad\AF_KP_fncs.sqf""";
};
class AF_Key9: RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""number"", 9]execVM ""USER\functions\phase0\keypad\AF_KP_fncs.sqf""";
};
class AF_Key_Clear: RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""clear"", 0]execVM ""USER\functions\phase0\keypad\AF_KP_fncs.sqf""";
};
class AF_Key0: RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""number"", 0]execVM ""USER\functions\phase0\keypad\AF_KP_fncs.sqf""";
};
class AF_Key_Enter: RscButton
{
	...
	w = 0.0700059 * safezoneW;
	h = 0.0700156 * safezoneH;
	Action = "[""enter"", 0]execVM ""USER\functions\phase0\keypad\AF_KP_fncs.sqf""";
};
