...
gradVM_portalPhaseTarget = getMarkerPos "mrk_phase_0_teleportTarget";

// stonehenge
gradVM_portalPhase_1 = 0;
gradVM_portalPhaseEnd_1 = 4;
gradVM_portalPhaseTarget = getMarkerPos "mrk_phase_1_teleportTarget";

// ww2 reichstag
gradVM_portalPhase_2 = 0;
gradVM_portalPhaseEnd_2 = 4;
gradVM_portalPhaseTarget = getMarkerPos "mrk_phase_2_teleportTarget";
